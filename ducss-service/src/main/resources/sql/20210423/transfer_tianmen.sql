-- 处理 湖北省天门市级丢失数据
-- 天门 : 429006  ；天门虚拟县 : 	429630

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '429630',city_id = '429006'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '429630' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '429630',city_id = '429006'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '429630' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '429630',city_id = '429006' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE area_id = '429630');

update collect_flow set city_id = '429006',level = '3' where area_id = '429630';
update collect_flow set city_id = '429006',level = '4' where area_id = '429006';

update straw_utilize_sum_total set province_id = '420000',city_id = '429006' where area_id = '429630';
update straw_utilize_sum_total set province_id = '420000',city_id = '429006' where area_id = '429006';

update straw_utilize_sum set city_id = '429006' where area_id = '429630';
update straw_utilize_sum set city_id = '429006' where area_id = '429006';
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '429630'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '429006';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '429006'
	GROUP BY
		city_ID,
	YEAR
	) B
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '429006'
) b
where
	a.year = b.year and a.city_id = b.city_id and a.straw_type = b.straw_type;

update data_analysis_city set area_name = '/湖北省/天门市' where city_id = '429006';