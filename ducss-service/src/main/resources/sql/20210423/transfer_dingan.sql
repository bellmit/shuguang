-- 处理 海南省定安市级丢失数据
-- 定安 : 469021  ；定安虚拟县 : 	469921

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469921',city_id = '469021'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469921' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469921',city_id = '469021'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469921' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469921',city_id = '469021' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE area_id = '469921');

update collect_flow set city_id = '469021',level = '3' where area_id = '469921';
update collect_flow set province_id = '460000',city_id = '469021',level = '4' where area_id = '469021';

update straw_utilize_sum_total set province_id = '460000',city_id = '469021' where area_id = '469921';
update straw_utilize_sum_total set province_id = '460000',city_id = '469021' where area_id = '469021';

update straw_utilize_sum set city_id = '469021' where area_id = '469921';
update straw_utilize_sum set city_id = '469021' where area_id = '469021';
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469921'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469021';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469021'
	GROUP BY
		city_ID,
	YEAR
	) B
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469021'
) b
where
	a.year = b.year and a.city_id = b.city_id and a.straw_type = b.straw_type;

update data_analysis_city set area_name = '/海南省/定安县' where city_id = '469021';