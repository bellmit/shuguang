-- 处理 中国吉林省公主岭市市级丢失数据
-- 公主岭市 : 220381  ；公主岭市县级 : 	220390

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '220390',city_id = '220381'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '220390' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '220390',city_id = '220381'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '220390' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '220390',city_id = '220381' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE area_id = '220390');

update collect_flow set city_id = '220381',level = '3' where area_id = '220390';
update collect_flow set city_id = '220381',level = '4' where area_id = '220381';

update straw_utilize_sum_total set province_id = '220000',city_id = '220381' where area_id = '220390';
update straw_utilize_sum_total set province_id = '220000',city_id = '220381' where area_id = '220381';

update straw_utilize_sum set city_id = '220381' where area_id = '220390';
update straw_utilize_sum set city_id = '220381' where area_id = '220381';
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '220390'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '220381';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '220381'
	GROUP BY
		city_ID,
	YEAR
	) B
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '220381'
) b
where
	a.year = b.year and a.city_id = b.city_id and a.straw_type = b.straw_type;

update data_analysis_city set area_name = '/吉林省/公主岭市' where city_id = '469007';