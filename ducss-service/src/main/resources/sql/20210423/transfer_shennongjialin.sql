-- 处理 湖北省神农架林市级丢失数据
-- 神农架林 : 429021  ；神农架林虚拟县 : 429030

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '429030',city_id = '429005'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '429030' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '429030',city_id = '429021'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '429030' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '429030',city_id = '429021' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE area_id = '429030');

update collect_flow set city_id = '429021',level = '3' where area_id = '429030';
update collect_flow set city_id = '429021',level = '4' where area_id = '429021';

update straw_utilize_sum_total set province_id = '420000',city_id = '429021' where area_id = '429030';
update straw_utilize_sum_total set province_id = '420000',city_id = '429021' where area_id = '429021';

update straw_utilize_sum set city_id = '429021' where area_id = '429030';
update straw_utilize_sum set city_id = '429021' where area_id = '429021';
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '429030'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '429021';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '429021'
	GROUP BY
		city_ID,
	YEAR
	) B
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '429021'
) b
where
	a.year = b.year and a.city_id = b.city_id and a.straw_type = b.straw_type;

update data_analysis_city set area_name = '/湖北省/神农架林区' where city_id = '429021';