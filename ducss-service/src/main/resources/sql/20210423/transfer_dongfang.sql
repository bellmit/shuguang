-- 处理 海南省东方市市级丢失数据
-- 东方市 : 469007  东方市虚拟县 : 469097

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469097',city_id = '469007'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469097' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469097',city_id = '469007'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469097' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469097',city_id = '469007' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE area_id = '469097');

update collect_flow set city_id = '469007',level = '3' where area_id = '469097';
update collect_flow set city_id = '469007',province_id = '460000' where area_id = '469007';

update straw_utilize_sum_total set province_id = '460000',city_id = '469007' where area_id = '469097';
update straw_utilize_sum_total set city_id = '469007' where area_id = '469007';
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469097'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469007';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469007'
	GROUP BY
		city_ID,
	YEAR
	) B
...
update straw_utilize_sum set city_id = '469007' where area_id = '469097';
update straw_utilize_sum set city_id = '469007' where area_id = '469007';
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469007'
) b
where
	a.year = b.year and a.city_id = b.city_id and a.straw_type = b.straw_type;

update data_analysis_city set area_name = '/海南省/东方市' where city_id = '469007';