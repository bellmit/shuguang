-- 2020-4-9
-- 469929 ： /海南省/保亭黎族苗族自治县/保亭黎族苗族自治县虚拟县
-- 469029 ： /海南省/保亭黎族苗族自治县
-- 保亭虚拟县数据上报被退回

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469929',city_id = '469029'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469029' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469929',city_id = '469029'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469029' );
UPDATE country_task SET area_id = '469929',city_id = '469029' WHERE id in (SELECT "id" FROM country_task WHERE area_id = '469029' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469929',city_id = '469029' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE year = '2018' AND area_id = '469029');


-- 备注： data_analysis_area 2020年保亭有重复数据
delete from data_analysis_area where year = '2020' and area_id = '469029' and id < 218681;

-- 插入18 19年保亭虚拟县的数据 （之前处理数据的时候处理掉了）
...
FROM
	...
	AND A.YEAR IN('2018','2019') AND a.area_id = '469929'
	) C;
...
WHERE
	D.B_ID = A.B_ID AND A.YEAR IN('2018','2019') AND a.area_id = '469929';
...
update data_analysis_area set RETURN_PERS = return_ratio / 100 where YEAR IN('2018','2019') and area_id = '469929';
...
WHERE
	A.B_ID = D.B_ID AND A.YEAR IN('2018','2019') and A.area_id = '469929';
...
FROM
    ...
    WHERE
	A.B_ID = F.B_ID AND F.YEAR IN('2018','2019') AND F.AREA_ID = '469929';
...
FROM
    ...
    where t2.year IN('2018','2019') and t2.area_id = '469929'
	GROUP BY
		B_ID
	) D
WHERE
...
SET REUSE = FERTILISINGD + FORAGED + FUELD + BASED + MATERIALD WHERE YEAR IN('2018','2019') AND AREA_ID = '469929';
...
FROM
	...
	FROM
		DATA_ANALYSIS_AREA
	where
	    year in ('2018','2019') and AREA_ID = '469929'
	GROUP BY
		AREA_ID,
	YEAR
	) B
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469929'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469029';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469029'
	GROUP BY
		city_ID,
	YEAR
	) B
...
-- 20年 琼中市的数据迁移到 city汇总表中  20年琼中市的数据被退回
--INSERT INTO data_analysis_city (
--	ID,
--	YEAR,
--	city_id,
...
-- 更新area表中的 area_id为保亭虚拟县的id
update data_analysis_area set area_id = '469929' where area_id = '469029';

-- 更新area汇总表中 区域名称
update data_analysis_area set area_name = '/海南省/保亭黎族苗族自治县/保亭黎族苗族自治县虚拟县' where area_id = '469929';

-- 更新city汇总表中 区域名称
update data_analysis_city set area_name = '/海南省/保亭黎族苗族自治县' where city_id = '469029';

-- 更新city_id
UPDATE straw_utilize_sum set province_id = '460000',city_id = '469029' where area_id = '469929';

UPDATE straw_utilize_sum set city_id = '469029' where area_id = '469029';
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and area_id = '469929'
) b
where
	a.area_id = b.area_id and a.year = b.year and a.straw_type = b.straw_type and a.area_id = '469929';
...
--return_pers = , -- 单作物的直接还田率
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469029'
) b
where
...
update collect_flow set city_id = '469029' where area_id = '469929';
update collect_flow set city_id = '469029', level = '4' where area_id = '469029';
...
INSERT INTO collect_flow (
	...
	buy_other_num,
	export_num
) SELECT year||province_id||city_id||'469929' as "id"
,
YEAR,
province_id,
city_id,
...
-- 市场主体更改保亭市数据
update straw_utilize_sum_total set city_id = '469029' where area_id = '469929';
update straw_utilize_sum_total set city_id = '469029' where area_id = '469029';


-- 上报管理
update collect_flow_log set area_id = '469929' where year = '2020' and area_id = '469029';
delete from country_task where id in('02afcf1f70d84e878660d9fa25dda7cd','2ea09265c94042aeabb31d303090ec63','0bff98f05084402592ab510083db47ce');
