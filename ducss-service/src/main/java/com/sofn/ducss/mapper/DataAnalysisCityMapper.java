...
import com.sofn.ducss.model.DataAnalysisCityV2;
...
public interface DataAnalysisCityMapper extends BaseMapper<DataAnalysisCity> {
    ...
    List<DataAnalysisCity> listByYearAndCityIdsAndTotolRateTooMuch(@Param("year") String year, @Param("cityIds") List<String> cityIds);
    ...
    List<DataAnalysisCityV2> getListsForV2All(@Param("paramMap") HashMap<String, Object> map);
    ...
    List<DataAnalysisCity> listByYearAndStrawTypeAndCityIds(@Param("year") String year, @Param("strawType") String strawType, @Param("cityIds") List<String> cityIds);

    void updateTotolRateByYearAndStrawTypeAndCityId(@Param("year") String year, @Param("strawType") String strawType,
                                                    @Param("cityId") String cityId, @Param("city") DataAnalysisCity city);

    List<DataAnalysisCity> listByAreaId();
}