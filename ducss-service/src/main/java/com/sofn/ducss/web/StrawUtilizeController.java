...
public class StrawUtilizeController {
    ...
    public Result<PageUtils<StrawUtilize>> getStrawUtilize(QueryPageVo queryVo, HttpServletRequest request) {
        ...
        if (StringUtils.isBlank(countyId)) {
            ...
            if (!RegionLevel.COUNTY.getCode().equals(firstArea.getRegionLevel())) {
                ...
                PageUtils<StrawUtilize> strawUtilizePageUtils = strawUtilizeService.listGroupByYearAndAreaId(queryMap);
                List<StrawUtilize> utilizeList = strawUtilizePageUtils.getList();
            ...
            PageUtils<StrawUtilize> strawUtilize = strawUtilizeService.getStrawUtilize(years, countyIds, pageNo, pageSize);
    ...
    public Result<PageUtils<StrawUtilize>> getStrawUtilizeList(StrawUtilizeQueryVo queryVo
        ...
        Integer pageNo = queryVo.getPageNo();
        Integer pageSize = queryVo.getPageSize();
        PageUtils<StrawUtilize> strawUtilizePageUtils = strawUtilizeService.getStrawUtilizeByPage(pageNo, pageSize, years, mainName, countyId, dateBegin, dateEnd);
