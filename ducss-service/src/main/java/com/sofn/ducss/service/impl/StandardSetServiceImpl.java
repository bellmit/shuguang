...
public class StandardSetServiceImpl implements StandardSetService {
     ...
     */
    @Override
    public Result<PageUtils<StandardSet>> selectPage(Integer pageNo, Integer pageSize, List<String> years) {
        PageHelper.offsetPage(pageNo, pageSize);

        ArrayList<StandardSet> list = standardSetMapper.getStandardSetList(years);
