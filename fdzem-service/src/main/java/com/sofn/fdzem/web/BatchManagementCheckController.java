...
@Slf4j
@Api(tags = "批次管理(审核)相关接口" )
@RestController
@RequestMapping("/batchManagementCheck")
public class BatchManagementCheckController {

    @Autowired
    private BatchManagementService batchManagementService;

    @GetMapping("/listPage")
    @RequiresPermissions("fdzem:batchManagementCheck:list")
    ...
    @GetMapping("/view")
    @RequiresPermissions("fdzem:batchManagementCheck:view")
