-- 处理 海南省屯昌市级丢失数据
-- 屯昌 : 469022  ；屯昌虚拟县 : 	469922

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469922',city_id = '469022'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469922' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469922',city_id = '469022'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469922' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469922',city_id = '469022' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE area_id = '469922');

update collect_flow set city_id = '469022',level = '3' where area_id = '469922';
update collect_flow set province_id = '460000',city_id = '469022',level = '4' where area_id = '469022';

update straw_utilize_sum_total set province_id = '460000',city_id = '469022' where area_id = '469922';
update straw_utilize_sum_total set province_id = '460000',city_id = '469022' where area_id = '469022';

update straw_utilize_sum set city_id = '469022' where area_id = '469922';
update straw_utilize_sum set city_id = '469022' where area_id = '469022';
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469922'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469022';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469022'
	GROUP BY
		city_ID,
	YEAR
	) B
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469022'
) b
where
	a.year = b.year and a.city_id = b.city_id and a.straw_type = b.straw_type;

update data_analysis_city set area_name = '/海南省/屯昌县' where city_id = '469022';