-- 处理 中国河北省雄安新区市级丢失数据
-- 雄安新区 : 130685  ；  下属县  : 容城县：130629，雄县：130638，安新县：130632

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET city_id = '130685' WHERE area_id in ('130629','130638','130632');
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET city_id = '130685' WHERE area_id in ('130629','130638','130632');
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET city_id = '130685' WHERE area_id in ('130629','130638','130632');

update collect_flow set city_id = '130685',level = '3' where area_id in ('130629','130638','130632');
update collect_flow set city_id = '130685',level = '4' where area_id = '130685';

update straw_utilize_sum_total set province_id = '130000',city_id = '130685' where area_id in ('130629','130638','130632');
update straw_utilize_sum_total set province_id = '130000',city_id = '130685' where area_id = '130685';

update straw_utilize_sum set city_id = '130685' where area_id in ('130629','130638','130632');
update straw_utilize_sum set city_id = '130685' where area_id = '130685';
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id in ('130629','130638','130632')
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '130685';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '130685'
	GROUP BY
		city_ID,
	YEAR
	) B
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '130685'
) b
where
	a.year = b.year and a.city_id = b.city_id and a.straw_type = b.straw_type;

update data_analysis_city set area_name = '/河北省/雄安新区' where city_id = '130685';