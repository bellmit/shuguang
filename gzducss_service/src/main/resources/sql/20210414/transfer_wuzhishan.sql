-- 2020-4-9
-- 469001 : /海南省/五指山市
-- 469091 : /海南省/五指山市/五指山市虚拟县
-- 五指山虚拟县数据上报未审核

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469091',city_id = '469001'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469001' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469091',city_id = '469001'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469001' );
UPDATE country_task SET area_id = '469091',city_id = '469001' WHERE id in (SELECT "id" FROM country_task WHERE area_id = '469001' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469091',city_id = '469001' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE year = '2018' AND area_id = '469001');

-- 插入18 19年五指山虚拟县的数据 （之前处理数据的时候处理掉了）
...
FROM
	...
	AND A.YEAR IN('2018','2019') AND a.area_id = '469091'
	) C;
...
WHERE
	D.B_ID = A.B_ID AND A.YEAR IN('2018','2019') AND a.area_id = '469091';
...
update data_analysis_area set RETURN_PERS = return_ratio / 100 where YEAR IN('2018','2019') and area_id = '469091';
...
WHERE
	A.B_ID = D.B_ID AND A.YEAR IN('2018','2019') and A.area_id = '469091';
...
FROM
    ...
    WHERE
	A.B_ID = F.B_ID AND F.YEAR IN('2018','2019') AND F.AREA_ID = '469091';
...
FROM
    ...
    where t2.year IN('2018','2019') and t2.area_id = '469091'
	GROUP BY
		B_ID
	) D
WHERE
...
SET REUSE = FERTILISINGD + FORAGED + FUELD + BASED + MATERIALD WHERE YEAR IN('2018','2019') AND AREA_ID = '469091';
...
FROM
	...
	FROM
		DATA_ANALYSIS_AREA
	where
	    year in ('2018','2019') and AREA_ID = '469091'
	GROUP BY
		AREA_ID,
	YEAR
	) B
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469091'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469001';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469001'
	GROUP BY
		city_ID,
	YEAR
	) B
...
-- 20年 五指山市的数据迁移到 city汇总表中  20年五指山县的数据上报未审核
--INSERT INTO data_analysis_city (
--	ID,
--	YEAR,
--	city_id,
...
update data_analysis_area set area_id = '469091' where area_id = '469001';

-- 更新area汇总表中 区域名称
update data_analysis_area set area_name = '/海南省/五指山市/五指山市虚拟县' where area_id = '469091';

-- 更新city汇总表中 区域名称
update data_analysis_city set area_name = '/海南省/五指山市' where city_id = '469001';

-- 更新city_id
UPDATE straw_utilize_sum set province_id = '460000',city_id = '469001' where area_id = '469001';
UPDATE straw_utilize_sum set city_id = '469001' where area_id = '469091';

-- 更新straw_utilize_sum表 将五指山市20年的数据复制一份到五指山市虚拟县中
...
id,
	...
	export_yield_total,
	grain_yield
) SELECT year||'469091'||straw_type as "id",YEAR
,
province_id,
city_id,
'469091',
...
FROM
	...
	WHERE straw_type=dict_key and year = '2020' and area_id = '469091');
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and area_id = '469091'
) b
where
	a.area_id = b.area_id and a.year = b.year and a.straw_type = b.straw_type and a.area_id = '469091';
...
--return_pers = , -- 单作物的直接还田率
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469001'
) b
where
...
update collect_flow set city_id = '469001' where area_id = '469091';
update collect_flow set city_id = '469001', level = '4' where area_id = '469001';
...
INSERT INTO collect_flow (
	...
	buy_other_num,
	export_num
) SELECT year||province_id||city_id||'469091' as "id"
,
YEAR,
province_id,
city_id,
...
-- 市场主体更改五指山市数据
update straw_utilize_sum_total set province_id = '460000',city_id = '469001' where area_id = '469001';
update straw_utilize_sum_total set city_id = '469001' where area_id = '469091';
INSERT INTO straw_utilize_sum_total (
	...
	year||province_id||city_id||'469091' as "id",
	YEAR,
	province_id,
	city_id,
	'469091',
...
-- 上报管理
update collect_flow_log set area_id = '469091' where year = '2020' and area_id = '469001';

delete from country_task where id in('443114311d254ff3afabd34e2b29d9a2','fdc10e48e69a46cdadaf0f4744791e9c','2f6e593649f6415c89c8e594fc3ef02b');
update country_task set status = '5' where year in ('2018','2019') and area_id = '469091';

delete from collect_flow where id = '6d4d87c0e7844f29afbba26137110645';