-- 2020-4-9
-- 469924 ： /海南省/临高县/临高县虚拟县
-- 469024 ： /海南省/临高县
-- 临高市虚拟县数据上报未审核

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469924',city_id = '469024'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469024' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469924',city_id = '469024'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469024' );
UPDATE country_task SET area_id = '469924',city_id = '469024' WHERE id in (SELECT "id" FROM country_task WHERE area_id = '469024' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469924',city_id = '469024' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE year = '2018' AND area_id = '469024');


-- 插入18 19年临高市虚拟县的数据 （之前处理数据的时候处理掉了）
...
FROM
	...
	AND A.YEAR IN('2018','2019') AND a.area_id = '469924'
	) C;
...
WHERE
	D.B_ID = A.B_ID AND A.YEAR IN('2018','2019') AND a.area_id = '469924';
...
update data_analysis_area set RETURN_PERS = return_ratio / 100 where YEAR IN('2018','2019') and area_id = '469924';
...
WHERE
	A.B_ID = D.B_ID AND A.YEAR IN('2018','2019') and A.area_id = '469924';
...
FROM
    ...
    WHERE
	A.B_ID = F.B_ID AND F.YEAR IN('2018','2019') AND F.AREA_ID = '469924';
...
FROM
    ...
    where t2.year IN('2018','2019') and t2.area_id = '469924'
	GROUP BY
		B_ID
	) D
WHERE
...
SET REUSE = FERTILISINGD + FORAGED + FUELD + BASED + MATERIALD WHERE YEAR IN('2018','2019') AND AREA_ID = '469924';
...
FROM
	...
	FROM
		DATA_ANALYSIS_AREA
	where
	    year in ('2018','2019') and AREA_ID = '469924'
	GROUP BY
		AREA_ID,
	YEAR
	) B
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469924'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469024';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469024'
	GROUP BY
		city_ID,
	YEAR
	) B
...
-- 20年 琼海市的数据迁移到 city汇总表中  20年琼海县的数据上报未审核
--INSERT INTO data_analysis_city (
--	ID,
--	YEAR,
--	city_id,
...
--	"data_analysis_area"
--WHERE
--	area_id = '469030' and year = '2020';

-- 更新area表中的 area_id为临高县的id
update data_analysis_area set area_id = '469924' where area_id = '469024';

-- 更新area汇总表中 区域名称
update data_analysis_area set area_name = '/海南省/临高县/临高县虚拟县' where area_id = '469924';

-- 更新city汇总表中 区域名称
update data_analysis_city set area_name = '/海南省/临高县' where city_id = '469024';

-- 更新city_id
UPDATE straw_utilize_sum set province_id = '460000',city_id = '469024' where area_id = '469024';
UPDATE straw_utilize_sum set city_id = '469924' where area_id = '469024';


-- 更新straw_utilize_sum表 将临高市20年的数据复制一份到、临高市虚拟县中
...
id,
	...
	export_yield_total,
	grain_yield
) SELECT year||'469924'||straw_type as "id",YEAR
,
province_id,
city_id,
'469924',
...
FROM
	...
	WHERE straw_type=dict_key and year = '2020' and area_id = '469924');
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and area_id = '469924'
) b
where
	a.area_id = b.area_id and a.year = b.year and a.straw_type = b.straw_type and a.area_id = '469924';
...
--return_pers = , -- 单作物的直接还田率
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469024'
) b
where
...
update collect_flow set city_id = '469024' where area_id = '469924';
update collect_flow set city_id = '469024', level = '4' where area_id = '469024';
...
INSERT INTO collect_flow (
	...
	buy_other_num,
	export_num
) SELECT year||province_id||city_id||'469924' as "id"
,
YEAR,
province_id,
city_id,
...
-- 市场主体更改临高市数据
update straw_utilize_sum_total set province_id = '460000',city_id = '469024' where area_id = '469024';
update straw_utilize_sum_total set city_id = '469024' where area_id = '469924';
...
-- 上报管理
update collect_flow set status = '5' where year = '2020' and area_id = '469924';
update collect_flow set status = '0' where year = '2020' and area_id = '469024';

update collect_flow_log set area_id = '469924',operation = '1' where id = '1fb7f7b29f204996a28db98fe64b51f6';

delete from country_task where id in('bd2622d5225f4cf19f371c80860a0c43','db527d568c2e4abf8125a6c19d4b2989','7c652de974a9472f826b3d9ba917e524');
update country_task set status = '1' where id = '88fe0c336da640f788e2563c8958596a';

update collect_flow set status = '1' where year = '2020' and area_id = '469924';
delete from collect_flow where id = '129b2186e6ab4701acad1d8ecb55d47d';
