-- 2020-4-9
-- 469030 ： /海南省/琼中黎族苗族自治县
-- 469930 : /海南省/琼中黎族苗族自治县/琼中黎族苗族自治县虚拟县
-- 琼中虚拟县上报数据被退回

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469930',city_id = '469030'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469030' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469930',city_id = '469030'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469030' );
UPDATE country_task SET area_id = '469930',city_id = '469030' WHERE id in (SELECT "id" FROM country_task WHERE area_id = '469030' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469930',city_id = '469030' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE year = '2018' AND area_id = '469030');


-- 插入18 19年琼中虚拟县的数据 （之前处理数据的时候处理掉了）
...
FROM
	...
	AND A.YEAR IN('2018','2019') AND a.area_id = '469930'
	) C;
...
WHERE
	D.B_ID = A.B_ID AND A.YEAR IN('2018','2019') AND a.area_id = '469930';
...
update data_analysis_area set RETURN_PERS = return_ratio / 100 where YEAR IN('2018','2019') and area_id = '469930';
...
WHERE
	A.B_ID = D.B_ID AND A.YEAR IN('2018','2019') and A.area_id = '469930';
...
FROM
    ...
    WHERE
	A.B_ID = F.B_ID AND F.YEAR IN('2018','2019') AND F.AREA_ID = '469930';
...
FROM
    ...
    where t2.year IN('2018','2019') and t2.area_id = '469930'
	GROUP BY
		B_ID
	) D
WHERE
...
SET REUSE = FERTILISINGD + FORAGED + FUELD + BASED + MATERIALD WHERE YEAR IN('2018','2019') AND AREA_ID = '469930';
...
FROM
	...
	FROM
		DATA_ANALYSIS_AREA
	where
	    year in ('2018','2019') and AREA_ID = '469930'
	GROUP BY
		AREA_ID,
	YEAR
	) B
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469930'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469030';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469030'
	GROUP BY
		city_ID,
	YEAR
	) B
...
update data_analysis_area set area_id = '469930' where area_id = '469030';

-- 更新area汇总表中 区域名称
update data_analysis_area set area_name = '/海南省/琼中黎族苗族自治县/琼中黎族苗族自治县虚拟县' where area_id = '469930';

-- 更新city汇总表中 区域名称
update data_analysis_city set area_name = '/海南省/琼中黎族苗族自治县' where city_id = '469030';

-- 更新city_id
UPDATE straw_utilize_sum set province_id = '460000',city_id = '469030' where area_id = '469030';

UPDATE straw_utilize_sum set city_id = '469030' where area_id = '469930';
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and area_id = '469930'
) b
where
	a.area_id = b.area_id and a.year = b.year and a.straw_type = b.straw_type and a.area_id = '469930';
...
--return_pers = , -- 单作物的直接还田率
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469030'
) b
where
...
update collect_flow set city_id = '469030' where area_id = '469930';
update collect_flow set city_id = '469030', level = '4' where area_id = '469030';
...
INSERT INTO collect_flow (
	...
	buy_other_num,
	export_num
) SELECT year||province_id||city_id||'469930' as "id"
,
YEAR,
province_id,
city_id,
...
-- 市场主体更改琼中市数据
update straw_utilize_sum_total set city_id = '469030' where area_id = '469030';
update straw_utilize_sum_total set city_id = '469030' where area_id = '469930';


-- 上报管理
update collect_flow_log set area_id = '469930' where year = '2020' and area_id = '469030';

delete from country_task where id in('1d7bdc713ef241c58961b3e1bd9f9b96','68079d4fcca64e1b92d4122308bf9d78','3772e0f7095540abad4c566db7ab8658');
update country_task set status = '5' where year in ('2018','2019') and area_id = '469930';