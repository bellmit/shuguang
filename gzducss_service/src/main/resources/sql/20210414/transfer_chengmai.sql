-- 2020-4-9
-- 469923 ： /海南省/澄迈县/澄迈县虚拟县
-- 469023 ： /海南省/澄迈县
-- 澄迈虚拟县数据上报未审核

-- 1.迁移产生量与直接还田量填报
UPDATE pro_still SET area_id= '469923',city_id = '469023'  WHERE  ID IN (SELECT ID
FROM pro_still WHERE area_id = '469023' );
-- 2.农户分散利用量填报
UPDATE disperse_utilize SET area_id = '469923',city_id = '469023'  WHERE ID IN (SELECT "id" FROM disperse_utilize WHERE area_id = '469023' );
UPDATE country_task SET area_id = '469923',city_id = '469023' WHERE id in (SELECT "id" FROM country_task WHERE area_id = '469023' );
-- 3.迁移市场主体利用量填报数据
UPDATE straw_utilize SET area_id = '469923',city_id = '469023' WHERE ID IN (SELECT "id" FROM straw_utilize  WHERE year = '2018' AND area_id = '469023');

-- 插入18 19年澄迈虚拟县的数据 （之前处理数据的时候处理掉了）
...
FROM
	...
	AND A.YEAR IN('2018','2019') AND a.area_id = '469923'
	) C;
...
WHERE
	D.B_ID = A.B_ID AND A.YEAR IN('2018','2019') AND a.area_id = '469923';
...
update data_analysis_area set RETURN_PERS = return_ratio / 100 where YEAR IN('2018','2019') and area_id = '469923';
...
WHERE
	A.B_ID = D.B_ID AND A.YEAR IN('2018','2019') and A.area_id = '469923';
...
FROM
    ...
    WHERE
	A.B_ID = F.B_ID AND F.YEAR IN('2018','2019') AND F.AREA_ID = '469923';
...
FROM
    ...
    where t2.year IN('2018','2019') and t2.area_id = '469923'
	GROUP BY
		B_ID
	) D
WHERE
...
SET REUSE = FERTILISINGD + FORAGED + FUELD + BASED + MATERIALD WHERE YEAR IN('2018','2019') AND AREA_ID = '469923';
...
FROM
	...
	FROM
		DATA_ANALYSIS_AREA
	where
	    year in ('2018','2019') and AREA_ID = '469923'
	GROUP BY
		AREA_ID,
	YEAR
	) B
...
FROM
	DATA_ANALYSIS_AREA
WHERE YEAR IN('2018','2019') and area_id = '469923'
GROUP BY
...
CASE
	...
	END WHERE YEAR IN('2018','2019') and city_id = '469023';
...
FROM
	...
	FROM
		data_analysis_city
	WHERE
	    year in ('2018','2019') and city_id = '469023'
	GROUP BY
		city_ID,
	YEAR
	) B
...
-- 20年 澄迈市的数据迁移到 city汇总表中  20年澄迈县的数据上报未审核
--INSERT INTO data_analysis_city (
--	ID,
--	YEAR,
--	city_id,
...
-- 更新area表中的 area_id为澄迈县的id
update data_analysis_area set area_id = '469923' where area_id = '469023';

-- 更新area汇总表中 区域名称
update data_analysis_area set area_name = '/海南省/澄迈县/澄迈县虚拟县' where area_id = '469923';

-- 更新city汇总表中 区域名称
update data_analysis_city set area_name = '/海南省/澄迈县' where city_id = '469023';

-- 更新city_id
UPDATE straw_utilize_sum set province_id = '460000',city_id = '469023' where area_id = '469023';
UPDATE straw_utilize_sum set city_id = '469023' where area_id = '469923';


update straw_utilize_sum set disperse_base = 0 where disperse_base is null;

-- 更新straw_utilize_sum表 将澄迈市20年的数据复制一份到澄迈市虚拟县中
...
id,
	...
	export_yield_total,
	grain_yield
) SELECT year||'469923'||straw_type as "id",YEAR
,
province_id,
city_id,
'469923',
...
FROM
	...
	WHERE straw_type=dict_key and year = '2020' and area_id = '469923');
...
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and area_id = '469923'
) b
where
	a.area_id = b.area_id and a.year = b.year and a.straw_type = b.straw_type and a.area_id = '469923';
...
--return_pers = , -- 单作物的直接还田率
from (
	SELECT * from straw_utilize_sum where year in ('2018','2019') and city_id = area_id and province_id != city_id and area_id = '469023'
) b
where
...
update collect_flow set city_id = '469023' where area_id = '469923';
update collect_flow set city_id = '469023', level = '4' where area_id = '469023';
...
INSERT INTO collect_flow (
	...
	buy_other_num,
	export_num
) SELECT year||province_id||city_id||'469923' as "id"
,
YEAR,
province_id,
city_id,
...
-- 市场主体更改澄迈市数据
update straw_utilize_sum_total set province_id = '460000',city_id = '469023' where area_id = '469023';
update straw_utilize_sum_total set city_id = '469023' where area_id = '469923';
...
-- 上报管理
update collect_flow set status = '0' where year = '2020' and area_id = '469023';

update collect_flow_log set area_id = '469923' where year = '2020' and area_id = '469023';

delete from country_task where id in('5d90a8d2adc448b8a7c88164eb88a16c','7c755545c1a841d6a8be4733aeee8616','4b23603e857c4c36971b53dc53f3bb1c');
update country_task set status = '5' where year in ('2018','2019') and area_id = '469923';
update country_task set status = '1' where year = '2020' and area_id = '469923';

delete from collect_flow where id = '21cac04087c5461b9a235dc7a3597f80';
