...
public interface SysDictMapper extends BaseMapper<SysDict> {
    ...
    List<SysDict> getDictListByType(@Param(value = "typevalue") String typevalue, @Param(value = "keyword") String keyword);

    List<SysDict> getDictListByTypeId(@Param(value = "typeId") String typeId);

    SysDict getAllByName(@Param(value = "dicttypeid") String dicttypeid, @Param("dictname") String dictname);
}
