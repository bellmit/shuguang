...
public class DisperseUtilizeController {
    ...
    public Result<PageUtils<DisperseUtilize>> getDisperseUtilize(QueryPageVo queryVo, HttpServletRequest request) {
        ...
        if (StringUtils.isBlank(countyId)) {
            ...
            PageUtils<DisperseUtilize> disperseUtilize = disperseUtilizeService.getDisperseUtilize(year, countyId, pageNo, pageSize);
    ...
    public Result<PageUtils<DisperseUtilize>> getDisperseUtilizeList(DisperseUtilizeQueryVo queryVo
        ...
        PageUtils<DisperseUtilize> disperseUtilizeByPage = disperseUtilizeService.getDisperseUtilizeByPage(pageNo, pageSize, year, userName, countyId, dateBegin, dateEnd, orderBy, sortOrder);
