...
public class StrawBigDataVo {
	...
	private List<com.sofn.ducss.vo.StrawProduceVo> strawProduces;

	@ApiModelProperty(name = "strawProduceResVo2s",value = "秸秆可收集量")
	private List<com.sofn.ducss.vo.StrawCollectVo> strawCollectVos;

	@ApiModelProperty(name = "strawFiveVos",value = "秸秆五料化")
	private List<com.sofn.ducss.vo.StrawFiveVo> strawFiveVos;
