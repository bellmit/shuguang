...
import com.sofn.ducss.service.impl.SysSubsystemServiceImpl;
import com.sofn.ducss.service.permission.PermissionRoleGroupService;
...
import com.sofn.ducss.util.SqlEscapeUtils;
...
public class PermissionSubSystemServiceImpl implements PermissionSubSystemService {
    ...
    public SysSubsystemTreeVo getUserHasSubsystem(String subsystemName) {
        ...
        params.put("keyword", SqlEscapeUtils.escape(subsystemName, SqlEscapeUtils.DB.MYSQL));
