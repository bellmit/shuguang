...
import com.sofn.ducss.service.SysResourceService;
import com.sofn.ducss.util.UserUtil;
import com.sofn.ducss.util.treeutil.basic.TreeGenerate;
import com.sofn.ducss.mapper.SysResourceMapper;
import com.sofn.ducss.service.permission.PermissionResourceService;
import com.sofn.ducss.vo.SysResourceForm;
...
public class PermissionResourceServiceImpl implements PermissionResourceService {
    ...
    public SysResourceTreeVo getUserHasResourceTree(String appId,String resourceName) {
        ...
        List<SysResourceForm> resourceByRoleIdsOrRoleCodesOrAppId = sysResourceService.getResourceByRoleIdsOrRoleCodesOrAppId(loginUserRoleIdList, Lists.newArrayList("ducss"), true,true);
        // 加上自己创建的
