...
public interface SyncSysRegionService {
     ...
     * @return List<String>
     */
    List<String> getAreaIdByStatus(String year, String regionYear, List<String> currentAreaIds, List<String> status);
     ...
     * @return
     */
    List<SysRegion> getAreaIdByParentId(String parentId);
    /**
     * 获取区划名字
     *
     * @param areaIds    区划ID
