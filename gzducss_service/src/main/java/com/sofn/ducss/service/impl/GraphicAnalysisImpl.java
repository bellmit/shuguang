...
import com.sofn.ducss.map.AdStatisticsData;
import com.sofn.ducss.map.MapConditions;
...
public class GraphicAnalysisImpl implements GraphicAnalysisService {
    ...
    private MapViewData getOutputData(String adLevel, String adCode, Map<String, String> conditions) {
        ...
        //获取下一级列表
        PageUtils<SysRegionTreeVo> result = sysApi.getSysRegionFormByParentId(null, parentId, null, null, null, null);
        List<SysRegionTreeVo> voList = result.getList();
