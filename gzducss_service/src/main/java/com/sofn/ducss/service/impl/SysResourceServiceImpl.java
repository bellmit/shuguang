...
import com.sofn.ducss.model.SysResource;
import com.sofn.ducss.model.SysSubsystem;
import com.sofn.ducss.service.SysResourceService;
import com.sofn.ducss.util.*;
import com.sofn.ducss.vo.RoleHaveResourceVo;
import com.sofn.ducss.vo.SysResourceBatchSaveVo;
...
public class SysResourceServiceImpl extends
    ...
    public List<SysResourceForm> getAllResourceBySubsystemId(String subsystemId) {
        ...
        SysSubsystem sss = sysSubsystemMapper.getSysSubsystemAppId(subsystemId);
        if (sss == null) {
