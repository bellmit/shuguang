...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public void createRole(SysRoleForm sysRoleForm) {
        SysSubsystem subsystemId = sysSubsystemMapper.getSysSubsystemAppId(sysRoleForm.getSubsystemId());
        if (subsystemId != null){
            sysRoleForm.setSubsystemId(subsystemId.getId());
        }else {
            sysRoleForm.setSubsystemId("");
        }
        // 1. 校验内容是否重复
        ...
        SysSubsystem sysSubsystem = sysSubsystemMapper.getSysSubsystemAppId(sysRoleForm.getSubsystemId());
        if (sysSubsystem != null ){
            role.setSubsystemId(sysSubsystem.getId());
        }
        // 如果没有填写角色代码 ， 则随机生成一个
    ...
    public void updateRole(SysRoleForm sysRoleForm) {
        ...
        selectSysRole.setSubsystemId(null);
