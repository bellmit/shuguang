...
import com.sofn.ducss.excel.test.testimport.ImportUserBean;
import com.sofn.ducss.excel.util.ExcelCheckUtil;
import com.sofn.ducss.excel.util.ExcelDictUtil;
import com.sofn.ducss.excel.util.ExcelReflectionUtil;
...
//            createTemplate(ImportUserBean.class, this.sheet, type);
    ...
    public static <E> void createExcel(Class cls, List<E> list,HttpServletResponse response, ZipOutputStream zipOutputStream) throws IOException {
         createExcels(cls, list, ExcelField.Type.EXPORT,response,zipOutputStream);
    }
     ...
     * @param <E>      E
     */
    private static <E> void createExcels(Class cls, List<E> list, ExcelField.Type type,HttpServletResponse response, ZipOutputStream zipOutputStream) throws IOException {
        ExportUtil ee = null;
        if (type != null) {
            ee = new ExportUtil(cls, type);
        } else {
