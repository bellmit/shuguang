package com.sofn.ducss.excel;

import com.google.common.collect.Lists;
import com.sofn.ducss.excel.annotation.ExcelField;
import com.sofn.ducss.excel.core.ExcelImport;
import com.sofn.ducss.excel.exception.ExcelException;
import com.sofn.ducss.excel.service.ExcelDataBatchInsertService;
import com.sofn.ducss.excel.test.SiteImport;
import com.sofn.ducss.excel.util.ExcelReflectionUtil;
import com.sofn.ducss.excel.util.ReadExcelForkJoin;
...
public class ExcelImportUtil {
    ...
    public static <T> List<T> getDataByExcel(MultipartFile multipartFile, int headerNum, Class<T> cls, Object sheetIndexOrName) throws ExcelException {
        ...
        try (
            ...
            e.printStackTrace();
            throw new ExcelException("读取文件异常,"+e.getMessage()+",请检查文件重新上传！");
        }
        return data;
    }
