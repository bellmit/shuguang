...
public class KnowledgeBaseController extends BaseController {
    ...
    @RequiresPermissions("agsjdm:knowledgebase:create")
    @SofnLog("新增知识库基础信息")
...
//         校验参数
    ...
    @RequiresPermissions("agsjdm:knowledgebase:view")
    ...
    @RequiresPermissions("agsjdm:knowledgebase:delete")
    @SofnLog("删除知识库基础信息")
    ...
    @RequiresPermissions("agsjdm:knowledgebase:update")
    @SofnLog("修改知识库基础信息")
