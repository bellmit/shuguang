...
//    @RequiresPermissions("sys:basedata:BaseDataType:update")
    ...
    public Result<PageUtils<SysBaseTypeAndDataVo>> getBaseTypeAndDataByPage(@ApiParam(value = "字典类型名称或者代码，模糊匹配") @RequestParam(required = false) String keyword,
        ...
        PageUtils<SysBaseTypeAndDataVo> sysBaseDataByPage = sysBaseDataTypeService.getSysBaseDataByPage(params, pageNo, pageSize);
