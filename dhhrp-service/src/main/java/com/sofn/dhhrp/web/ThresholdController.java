...
import com.sofn.dhhrp.service.ThresholdService;
...
public class ThresholdController extends BaseController {
    ...
    @RequiresPermissions("dhhrp:threshold:create")
    ...
    @RequiresPermissions("dhhrp:threshold:delete")
    ...
    @RequiresPermissions("dhhrp:threshold:view")
    ...
    @RequiresPermissions("dhhrp:threshold:update")
