...
/**
 * @Description: 企业注册明细对象
 * @Author: wuXY
 * @Date: 2019-12-30 13:51:50
 */
@Data
@ApiModel(value="企业注册明细对象")
public class EnterpriseVo {
    ...
    @Length(max = 50,message = "公司名称不能超过50位")
