 ...
 */
@Deprecated
@Api(value = "APP_问题相关接口",tags = "APP_问题相关接口")
@RestController
@Slf4j
@RequestMapping(value = "/app/question")
public class QuestionAppController extends BaseController {
    @Autowired
...
//    @RequiresPermissions("fdpi:questions:create")
    ...
    public Result updateQuestion(@Validated @RequestBody @ApiParam(name = "解答对象",
        ...
        String s=null;
//        String s = qService.updateQuestion(questionFrom);
