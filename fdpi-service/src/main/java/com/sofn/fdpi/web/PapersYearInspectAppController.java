...
@Api(value="APP_证书年审管理相关接口",tags = "APP_证书年审管理相关接口")
@RestController
@RequestMapping("/app/papersYearInspect")
public class PapersYearInspectAppController extends BaseController {
    @Autowired
    ...
    public Result<PapersYearInspectProcess> getProcessByInspectId(@RequestParam("inspectId") @ApiParam(name = "inspectId", value = "证书年审id", required = true) String inspectId
        ...
        return Result.ok(papersYearInspectService.getProcessByInspectId(inspectId, status));
    }
