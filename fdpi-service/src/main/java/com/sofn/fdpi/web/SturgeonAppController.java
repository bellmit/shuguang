...
@Api(value = "APP_鲟鱼子酱标识申请相关接口", tags = "APP_鲟鱼子酱标识申请相关接口")
@RestController
@RequestMapping(value = "/app/sturgeon")
public class SturgeonAppController extends BaseController {
...
//    @RequiresPermissions("fdpi:sturgeonApply:update")
    ...
    @GetMapping("/get")
//    @RequiresPermissions(value = {"fdpi:sturgeonApply:view", "fdpi:sturgeonApprove:view"}, logical = Logical.OR)
...
//    @RequiresPermissions("fdpi:sturgeonApprove:back")
    ...
    public Result<PageUtils<SturgeonVo>> listPage(
            ...
            @ApiParam(value = "申请类型1国外2国内", required = true) @RequestParam() String applyType,
        ...
        Object[] vals = {applyDateS, applyDateE, compName, auditer, credentials, trade, status, applyType, variety};
        String[] keys = {"applyDateS", "applyDateE", "compName", "auditer", "credentials", "trade", "status", "applyType", "variety"};
