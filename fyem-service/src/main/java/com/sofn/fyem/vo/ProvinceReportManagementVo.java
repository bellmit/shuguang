...
/**
 * @Description: 省级上报管理Vo
 * @Author: DJH
 * @Date: 2020/4/28 14:34
 */
@ApiModel(value = "ProvinceReportManagementVo", description = "省上报管理Vo")
@Data
@EqualsAndHashCode(callSuper = false)
public class ProvinceReportManagementVo extends BaseVo<ProvinceReportManagementVo> {
    ...
    @ApiModelProperty(name = "reportCount", value = "上报")
    private String reportCount;

    @ApiModelProperty(name = "shouldReportCount", value = "应报")
