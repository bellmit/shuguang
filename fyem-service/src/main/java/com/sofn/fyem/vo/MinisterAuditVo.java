...
/**
 * @Description: 部级审核数据Vo
 * @Author: DJH
 * @Date: 2020/4/28 14:05
 */
@ApiModel(value = "MinisterAuditVo", description = "部级审核数据Vo")
@TableName(value = "MINISTER_AUDIT")
@Data
@EqualsAndHashCode(callSuper = false)
public class MinisterAuditVo extends BaseVo<MinisterAuditVo> {
