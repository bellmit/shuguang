...
public class TestController extends BaseController {
    ...
    @ApiOperation(value = "获取登陆者区域id")
    @GetMapping("/getUserAreaIdByLogUser")
    public Result getUserAreaIdByLogUser() {
        return Result.ok(FyemAreaUtil.getUserAreaIdByLogUser(sysRegionApi));
    }

    @ApiOperation(value = "获取下级机构")
    @GetMapping("/getListCountByParentId")
    public int getListCountByParentId(){
        int count = FyemAreaUtil.getListCountByParentId(sysRegionApi);
        return count;
    }
}
